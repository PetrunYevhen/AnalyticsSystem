...
public sealed class DeleteCustomersFromCampaignCommandValidator : AbstractValidator<DeleteCustomersFromCampaignCommand>
{
    public DeleteCustomersFromCampaignCommandValidator()
    {
        ...
        RuleFor(x => x.CustomerIds)
            ...
            .WithMessage("За один раз можна видалити не більше 1000 клієнтів.")
