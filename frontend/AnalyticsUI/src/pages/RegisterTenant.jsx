        ...
        <div className="min-h-screen flex items-center justify-center bg-muted/40 p-4">
            ...
            <Card className="w-full max-w-md shadow-lg">
                <CardHeader className="space-y-1 text-center">
                    <CardTitle className="text-2xl font-bold tracking-tight">Реєстрація організації</CardTitle>
                    <CardDescription>
                ...
                <CardContent className="space-y-4">
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="relative">
                            ...
                            <Input id="tenantName" placeholder="Введіть назву..." className="pl-9" />
                        </div>
                    </div>
                ...
                <CardFooter>
                    <Button className="w-full text-md h-10">Створити робочий простір</Button>
                </CardFooter>
            </Card>
